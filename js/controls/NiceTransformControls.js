...
( function () {
	...
	THREE.TransformGizmoNice = function () {
		...
		this.buildArrow = function (e) {
	        ...
	        var material = new THREE.MeshBasicMaterial({visible: false, color: 0xFF0000, side: THREE.DoubleSide});
		...
		this.arrowOuterPoints = function () {
	  	...
	  	var arrowBorder = this.buildArrow(this.arrowOuterPoints());
        arrowBorder.name = "ARROW_BORDER";
        arrowBorder.material.color.set( 0xFF0000 )
        // arrowBorder.opacity = 1;
        // arrowBorder.visible = false;

        var arrow = this.buildArrow(this.arrowPoints());
        // r.opacity = 0.6;
		...
		this.pickerGizmos = {
			...
			Z: [
				[ arrowBorder, [0, 0, 800] ,[ 0, 0, - Math.PI / 2 ]],
				[ arrowBorder, [0, 0, 800], [ 0, 0, - Math.PI / 2 ] ]
			]
		};
		...
		this.setActivePlane = function ( axis, eye ) {
			...
			if ( axis === "Z" ) {
				...
				this.activePlane = this.planes[ "Z" ];
	...
	THREE.TransformGizmoNice.prototype = Object.create( THREE.TransformGizmo.prototype );
	THREE.TransformGizmoNice.prototype.constructor = THREE.TransformGizmoNice;
	...
	THREE.TransformControls = function ( camera, domElement ) {
		...
		var _dragging = false;
		var _gizmo = {
			"nice": new THREE.TransformGizmoNice(),
